...
m4_define(mca_memory_m4_config_component_list, [darwin, malloc_hooks, ptmalloc2, malloc_interpose])
m4_define(mca_paffinity_no_config_component_list, [])
m4_define(mca_paffinity_m4_config_component_list, [linux, solaris])
m4_define(mca_timer_no_config_component_list, [])
m4_define(mca_timer_m4_config_component_list, [aix, altix, darwin, solaris, linux])
m4_define(mca_opal_framework_list, [maffinity, memory, paffinity, timer])
m4_define(mca_errmgr_no_config_component_list, [])
...
m4_define(mca_pls_no_config_component_list, [daemon, proxy])
m4_define(mca_pls_m4_config_component_list, [bproc, bproc_orted, fork, poe, rsh, slurm, tm, xgrid])
m4_define(mca_ras_no_config_component_list, [dash_host, hostfile, localhost])
m4_define(mca_ras_m4_config_component_list, [bjs, lsf_bproc, slurm, tm, xgrid])
m4_define(mca_rds_no_config_component_list, [hostfile, resfile])
...
m4_define(mca_rmgr_m4_config_component_list, [])
...
m4_define(mca_sds_no_config_component_list, [env, seed, singleton, slurm])
m4_define(mca_sds_m4_config_component_list, [bproc, cnos, pipe, portals_utcp])
m4_define(mca_soh_no_config_component_list, [])
m4_define(mca_soh_m4_config_component_list, [bproc])
m4_define(mca_orte_framework_list, [errmgr, gpr, iof, ns, oob, pls, ras, rds, rmaps, rmgr, rml, schema, sds, soh])
...
m4_define(mca_btl_m4_config_component_list, [gm, mvapi, mx, openib, portals, tcp])
m4_define(mca_coll_no_config_component_list, [basic, self, sm])
m4_define(mca_coll_m4_config_component_list, [])
m4_define(mca_common_no_config_component_list, [sm])
m4_define(mca_common_m4_config_component_list, [])
m4_define(mca_io_no_config_component_list, [])
m4_define(mca_io_m4_config_component_list, [romio])
m4_define(mca_mpool_no_config_component_list, [sm])
m4_define(mca_mpool_m4_config_component_list, [gm, mvapi, openib])
m4_define(mca_pml_no_config_component_list, [ob1, teg])
m4_define(mca_pml_m4_config_component_list, [])
m4_define(mca_ptl_no_config_component_list, [self, sm])
m4_define(mca_ptl_m4_config_component_list, [gm, mx, tcp])
m4_define(mca_rcache_no_config_component_list, [rb])
...
m4_define(mca_ompi_framework_list, [allocator, bml, btl, coll, common, io, mpool, pml, ptl, rcache, topo])
...
dnl m4-configure component: 
dnl    opal/mca/memory/malloc_interpose

AC_CONFIG_FILES([opal/mca/memory/malloc_interpose/Makefile])
dnl ----------------------------------------------------------------
...
dnl m4-configure component: 
dnl    orte/mca/pls/bproc_orted

AC_CONFIG_FILES([orte/mca/pls/bproc_orted/Makefile])
dnl ----------------------------------------------------------------

dnl No-configure component: 
dnl    orte/mca/pls/daemon

AC_CONFIG_FILES([orte/mca/pls/daemon/Makefile])
dnl ----------------------------------------------------------------

dnl m4-configure component: 
dnl    orte/mca/pls/fork

AC_CONFIG_FILES([orte/mca/pls/fork/Makefile])
dnl ----------------------------------------------------------------
...
dnl No-configure component: 
dnl    orte/mca/ras/hostfile

AC_CONFIG_FILES([orte/mca/ras/hostfile/Makefile])
dnl ----------------------------------------------------------------
...
dnl m4-configure component: 
dnl    orte/mca/soh/bproc

AC_CONFIG_FILES([orte/mca/soh/bproc/Makefile])
dnl ----------------------------------------------------------------
...
dnl m4-configure component: 
dnl    ompi/mca/mpool/gm

AC_CONFIG_FILES([ompi/mca/mpool/gm/Makefile])
dnl ----------------------------------------------------------------

dnl m4-configure component: 
dnl    ompi/mca/mpool/mvapi

AC_CONFIG_FILES([ompi/mca/mpool/mvapi/Makefile])
dnl ----------------------------------------------------------------

dnl m4-configure component: 
dnl    ompi/mca/mpool/openib

AC_CONFIG_FILES([ompi/mca/mpool/openib/Makefile])
dnl ----------------------------------------------------------------
...
dnl No-configure component: 
dnl    ompi/mca/pml/teg

AC_CONFIG_FILES([ompi/mca/pml/teg/Makefile])
dnl ----------------------------------------------------------------

dnl m4-configure component: 
dnl    ompi/mca/ptl/gm

AC_CONFIG_FILES([ompi/mca/ptl/gm/Makefile])
dnl ----------------------------------------------------------------

dnl m4-configure component: 
dnl    ompi/mca/ptl/mx

AC_CONFIG_FILES([ompi/mca/ptl/mx/Makefile])
dnl ----------------------------------------------------------------

dnl No-configure component: 
dnl    ompi/mca/ptl/self

AC_CONFIG_FILES([ompi/mca/ptl/self/Makefile])
dnl ----------------------------------------------------------------

dnl No-configure component: 
dnl    ompi/mca/ptl/sm

AC_CONFIG_FILES([ompi/mca/ptl/sm/Makefile])
dnl ----------------------------------------------------------------

dnl m4-configure component: 
dnl    ompi/mca/ptl/tcp

AC_CONFIG_FILES([ompi/mca/ptl/tcp/Makefile])
dnl ----------------------------------------------------------------

dnl No-configure component: 
dnl    ompi/mca/rcache/rb

AC_CONFIG_FILES([ompi/mca/rcache/rb/Makefile])
dnl ----------------------------------------------------------------
