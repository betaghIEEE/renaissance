...
private:
 ...
 public:
  ...
  imageType (int rows, int cols, double *m);
  ...
  //  Added March 31, 2002 for inclusion of svd, and matrix adjustment.
  bool addRow ();
  bool getRow (int row, double * output);
  void copyLapackToMatrix(int rows, int cols, double *input);
  void copyMatrixToLapack(int rows, int cols, double * output);
