...
class xform
{
	...
	public:
		...
		void evenPick ( myVector &a, myVector &d , myVector &result);
		...
		void hWaveEven (myVector &input, myVector &result);
		void hWave (myVector &input, myVector &result, int
		resolution);
		
		void hWaveEven (myVector &input, myVector &result, int resolution);
